...
int serial_plotter = 0; //protocolo de envio de datos. 
...
float Fs_Hz = 2000;    // Sampling frequency and execution time 
...
//int state = 0; //
 ...
 int pin12 = LOW; //state for output at pin12 to measure execution time
